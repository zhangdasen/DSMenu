...
- (void) setupFrameInView:(UIView *)view
                 fromRect:(CGRect)fromRect isWhite:(BOOL)isWhite
{
    iswhite=isWhite;
             ...
             isWhite:(BOOL)isWhite
{
    ...
    [self setupFrameInView:view fromRect:rect isWhite:(BOOL)isWhite];
...
- (UIView *) mkContentView
{
    ...
    const CGFloat kMinMenuItemHeight = 42.0f;
    const CGFloat kMinMenuItemWidth = ScreenWidth/2.5;
    ...
    maxItemWidth  = MIN(maxItemWidth, kMinMenuItemWidth);
             ...
             inContext:(CGContextRef) context
{
    ...
    CGFloat R0 = 0.230, G0 = 0.571, B0 = 0.871;
...
- (void) showMenuInView:(UIView *)view
               fromRect:(CGRect)rect
              menuItems:(NSArray *)menuItems isWhite:(BOOL)isWhite
{
    ...
    [_menuView showMenuInView:view fromRect:rect menuItems:menuItems isWhite:isWhite];
}
...
{
    iswhite=isWhite;
    [[self sharedMenu] showMenuInView:view fromRect:rect menuItems:menuItems isWhite:(BOOL)isWhite];
}
